...
const Navbar = () => {
  ...
  return (
    <>
      <div
        className="sticky top-0 z-50 flex items-center shadow-sm shadow-black bg-sky-700 h-20 w-full"
        ...
        <div className="text-white w-[95%] flex mx-auto items-center h-16 justify-between">
          ...
          <div className="flex items-center">
            <div className="space-x-4">
              ...
              />
              <button className="border-[1px] border-black py-2 px-4 rounded-lg shadow-sm shadow-black">
                Search
              </button>
            </div>
            {/* modes */}
